        ...
        <form action="#" @submit.prevent="handleSaveDriver">
            <div class="overflow-hidden shadow sm:rounded-md max-w-sm mx-auto text-left">
                <div class="bg-white px-4 py-5 sm:p-6">
                    <div>
                        <input type="text" name="name" v-model="driverDetails.name" id="name" placeholder="Full Name"
                    ...
                    <div class="mt-2">
                        <input type="text" name="make" v-model="driverDetails.make" id="make" placeholder="Make"
                            class="mt-1 block w-full px-3 py-2 rounded-md border border-gray-300 shadow-sm focus:border-black focus:outline-none">
                    </div>
                    <div class="mt-2">
